...
//This useeffect is for resizing the Screen , so that everything is in place if we do resize also
  useEffect(() => {
...
//this useeffect is for hiding the sidebar whenever the screen size varies.
  useEffect(() => {
    if(screenSize <= 900) {
      setActiveMenu(false);
    } else {
    ...
    position="BottomCenter">
      ...
      ('userProfile')}>
        ...
        <p>
          ...
          <span className='text-gray-400 font-bold ml-1 text-14'>Reet</span>
        </p>
